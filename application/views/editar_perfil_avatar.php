<div id="content">
    <h1>Editar Perfil - Alterar Imagem</h1> 
    <div>
        <form action="editar_perfil/alter_avatar" method="POST" id="form_editar_cadastro" class="form_geral" enctype="multipart/form-data">
            <fieldset>
