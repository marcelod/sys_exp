<div id="form-login">    
    ...
    <form action="home/send" method="POST" id="form_login">
        ...
        <fieldset>
            ...
            <a href="cadastrar" title="Cadastrar">Cadastrar novo usu&aacute;rio</a> | 
            <a href="esquecisenha" title="Esqueci a senha">Esqueci a senha</a>
